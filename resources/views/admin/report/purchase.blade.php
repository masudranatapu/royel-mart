                ...
                <div class="page-body">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-8">
                                    <h2>Purchase <small class="badge bg-success text-white">{{ $purchases->count() }}</small></h2>
                                </div>
                                <div class="col-md-4 text-right">
                                    <form class="row" action="{{ route('admin.purchase-report-search') }}" method="GET" enctype="multipart/form-data">
